		...
		public function displayPublishPanel(XMLElement &$wrapper, $data = null, $flagWithError = null, $fieldnamePrefix = null, $fieldnamePostfix = null, $entry_id = null) {
			...
			if(is_null($entry_id) && !is_null($this->get('default_keys'))) {
				...
				if(is_array($defaults) && !empty($defaults)) foreach($defaults as $i => $key) {
					$_POST['fields'] = $_POST['fields'] ?? null;
					$_POST['fields'][$field_handle] = $_POST['fields'][$field_handle] ?? null;
					$_POST['fields'][$field_handle][$i] = $_POST['fields'][$field_handle][$i] ?? null;
					$_POST['fields'][$field_handle][$i]['value'] = $_POST['fields'][$field_handle][$i]['value'] ?? null;
