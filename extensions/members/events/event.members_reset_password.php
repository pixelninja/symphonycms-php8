<?php
	...
	Class eventMembers_Reset_Password extends MembersEvent {
		...
		public function load(){
			// $_POST['action'][self::ROOTELEMENT] = $_POST['action'][self::ROOTELEMENT] ?? null;
		...
		protected function __trigger(){
			...
			$fields[extension_Members::getFieldHandle('identity')] = $fields[extension_Members::getFieldHandle('identity')] ?? null;
			...
			$_REQUEST['members-section-id'] = $_REQUEST['members-section-id'] ?? null;
