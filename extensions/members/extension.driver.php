		...
		public function checkFrontendPagePermissions($context) {
			...
			// Login
				...
				if (!$isLoggedIn) {
					...
					$_POST['fields'][extension_Members::getFieldHandle('identity')] = $_POST['fields'][extension_Members::getFieldHandle('identity')] ?? null;
					$_POST['fields'][extension_Members::getFieldHandle('email')] = $_POST['fields'][extension_Members::getFieldHandle('email')] ?? null;
