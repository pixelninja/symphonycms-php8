	...
	Class contentExtensionMembersRoles extends AdministrationPage {
		...
		public function __viewEdit() {
			...
			if(is_array($events) && !empty($events)) foreach($events as $event_handle => $event){
				...
				$fields['permissions'][$event_handle] = $fields['permissions'][$event_handle] ?? null;
				$permissions = $fields['permissions'][$event_handle];
				$permissions['create'] = $permissions['create'] ?? null;
				$permissions['edit'] = $permissions['edit'] ?? null;
		...
		public function __actionEdit() {
			...
			if(array_key_exists('save', $_POST['action'])) {
				...
				$fields['page_access'] = $fields['page_access'] ?? null;
