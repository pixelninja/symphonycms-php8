<?php
	...
	class FieldEntry_Relationship extends FieldRelationship
	{
		...
		public function setFromPOST(Array $settings = array())
		{
			...
			// set new settings
			$new_settings['sections'] = $new_settings['sections'] ?? null;
			$settings['sections'] = $settings['sections'] ?? null;
			...
			$settings['allow_new'] = $settings['allow_new'] ?? null;
			$settings['allow_edit'] = $settings['allow_edit'] ?? null;
			$settings['allow_link'] = $settings['allow_link'] ?? null;
			$settings['allow_delete'] = $settings['allow_delete'] ?? null;
			$settings['allow_collapse'] = $settings['allow_collapse'] ?? null;
			$settings['allow_search'] = $settings['allow_search'] ?? null;
			$settings['show_header'] = $settings['show_header'] ?? null;
		...
		public function displayPublishPanel(XMLElement &$wrapper, $data = null, $flagWithError = null, $fieldnamePrefix = null, $fieldnamePostfix = null, $entry_id = null)
		{
			...
			$data['entries'] = $data['entries'] ?? null;
