...
class Tracker
{
    public static function log($item_type, $item_id, $action_type, $user_id, $timestamp)
    {
         ...
         */
        $_SESSION['sym-members'] = $_SESSION['sym-members'] ?? 0;
        $author = null;
        ...
        if ($author instanceof Author) {
            ...
            $members['username'] = $members['username'] ?? null;
            $members['email'] = $members['email'] ?? null;
            $members['members-section-id'] = $members['members-section-id'] ?? null;
            $members['id'] = $members['id'] ?? null;

            if (!is_array($user_id)) $user_id = array();
            $user_id['username'] = $user_id['username'] ?? null;
            $user_id['email'] = $user_id['email'] ?? null;
